      ...
      <section id="access" className="relative py-20 px-4 md:px-8 bg-primary">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            ...
            >
              <h3 className="text-xl font-bold mb-4 text-white">新宿ハイジアV-1</h3>
              <p className="mb-2 text-white/60"><span className="font-medium text-white/80">住所:</span> 〒160-0021 東京都新宿区歌舞伎町2-44-1 ハイジアB1</p>
              <p className="mb-6 text-white/60"><span className="font-medium text-white/80">アクセス:</span> 東京メトロ副都心線・都営大江戸線 東新宿駅より徒歩3分 / JR新宿駅東口より徒歩10分 / 西武新宿駅より徒歩5分</p>

              <div className="aspect-video relative rounded-lg overflow-hidden border border-white/10">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3240.5!2d139.7003!3d35.6966!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188cd5c0ae8cf5%3A0x6ed4c15e1e5a7b23!2z5paw5a6_44OP44Kk44K444Ki!5e0!3m2!1sja!2sjp!4v1704800000000"
                  width="100%"
                  height="100%"
