        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            ...
            >
              ...
              <p className="mb-2"><span className="font-medium">住所:</span> 〒160-0021 東京都新宿区歌舞伎町２丁目４４−１ 東京都健康プラザハイジア b1</p>
              <p className="mb-6"><span className="font-medium">アクセス:</span> 新宿駅から徒歩8分、西武新宿駅から徒歩3分</p>
              
              <div className="aspect-video relative rounded-lg overflow-hidden">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3240.2847447!2d139.7004!3d35.6952!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188d2059b7fd0b%3A0x8d0d1b0d8d0d8d0d!2z5p2x5Lqs6YO95paw5a6_5Yy65q2M6Iie5Lyd55S677yS5LiB55uu77yU77yU4oiS77yR!5e0!3m2!1sja!2sjp!4v1234567890" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="新宿ハイジアV-1の地図"
                  aria-label="新宿ハイジアV-1の地図 - 東京都新宿区歌舞伎町2-44-1 東京都健康プラザハイジア b1"
                ></iframe>
              </div>
            </motion.div>
