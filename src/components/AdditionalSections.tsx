        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <p>
              ...
              主役は、日々進化を続けるGATE所属の若手お笑い芸人たちと。さらに、毎回迎える実力派ゲストとの化学反応から生まれる、
              予測不能でエッジの効いた展開もこのライブならではの醍醐味。
            </p>
            <p>
              ここでしか見られない貴重な組み合わせや、この日限りの特別な企画が、あなたの五感を刺激します。
              ライブならではの熱気、画面越しでは伝わらない生の迫力、そしてブレイク前夜の才能が放つ眩いばかりの輝きを、
              ぜひ会場で体感してください。
            </p>
            <p>
              ありふれた日常に、最高にクールな一夜を。未来のスターを目撃しに、ぜひお越しください。
            </p>
          </motion.div>
        </div>
      </section>
