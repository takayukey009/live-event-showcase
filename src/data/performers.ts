...
export const performers: Performer[] = [
  ...
  { id: 5, name: '家族チャーハン', image: '/images/家族チャーハン.jpg', isGuest: true, description: 'ゲスト芸人' },
  { id: 6, name: 'ガングリオン', image: '/images/ガングリオン.jpg', isGuest: true, description: 'ゲスト芸人' },
  { id: 7, name: 'テツロー', image: '/images/テツロー.jpg', isGuest: true, description: 'ゲスト芸人' },
];
