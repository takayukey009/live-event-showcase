...
export const currentEvent: LiveEvent = {
  ...
  eventName: 'YAGATE',
  eventVolume: 'vol. 34',
  description: `毎月、都内（主に新宿・下北沢）で開催されるGATEがお届けする若手お笑いライブ「YAGATE」。主役は、日々進化を続けるGATE所属の若手お笑い芸人、友田オレ・リンドバーグ・イクラボブチャンチャン・シャワーカーテニスト。さらに今回はゲストにケビンスを迎え、化学反応にご期待ください。
